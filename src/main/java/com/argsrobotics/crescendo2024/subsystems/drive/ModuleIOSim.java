...
public class ModuleIOSim implements ModuleIO {
  ...
  private DCMotorSim driveSim = new DCMotorSim(DCMotor.getNEO(1), kDriveGearRatio, 0.025);
  private DCMotorSim turnSim = new DCMotorSim(DCMotor.getNEO(1), kTurnGearRatio, 0.004);
