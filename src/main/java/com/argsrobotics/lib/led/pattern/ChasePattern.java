...
/**
 * A chase pattern that can be applied to an LED strip. This pattern will override the value of the
 * primary color. The hue and saturation of the primary color are applied to the chase. The
