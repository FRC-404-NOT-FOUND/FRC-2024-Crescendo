...
/**
 * A rainbow pattern that can be applied to an LED strip. This pattern will override the hue of the
 * primary color. The saturation and value of the primary color are applied to the rainbow. The
 * secondary color is not used.
 *
