...
/**
 * A pattern that can be applied to an LED strip. This pattern will mimic the merge sort algorithm.
 * It will override the hue of the primary color. The saturation and value of the primary color
 * remain the same. The secondary color is not used. The pattern duration is approximated but might
 * not be exact.
 *
 * @see LEDStrip
 */
