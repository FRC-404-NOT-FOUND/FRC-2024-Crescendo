...
/**
 * A wave pattern that can be applied to an LED strip. This pattern will interpolate between the
 * primary and secondary colors. These colors will shift over time.
 *
